...
import yome.fgo.simulator.models.combatants.ActiveSkill.ActiveSkillWrapper;

import java.util.List;
import java.util.stream.Collectors;

public class MysticCode {
    public final List<ActiveSkillWrapper> activeSkills;
    ...
    public MysticCode(final MysticCodeData mysticCodeData, final MysticCodeOption mysticCodeOption) {
        this.activeSkills = mysticCodeData.getActiveSkillDataList()
                .stream()
                .map(activeSkillData -> new ActiveSkillWrapper(activeSkillData, mysticCodeOption.getMysticCodeLevel()))
